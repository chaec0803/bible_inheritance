export const GIFT_BGM_CATALOG = {
  'still-waters': { name: 'Aeternum', audioSrc: '/api/bgm/aeternum?v=2', objectKey: 'bgm/aeternum.mp3' },
  'peaceful-morning': { name: 'Unto Thee', audioSrc: '/api/bgm/unto-thee?v=2', objectKey: 'bgm/unto-thee.mp3' },
  'word-breath': { name: "The King's Return", audioSrc: '/api/bgm/the-kings-return?v=2', objectKey: 'bgm/the-kings-return.mp3' },
